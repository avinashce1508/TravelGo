...
void flight::fdbook()
{
	...
	cout<<"\n\t Time  : "<<a.journeyTime<<"\n";
	cout<<"\n\t Fare  : "<<a.f<<"\n";
	cout<<"\n Payment to be made through Demand Draft in favour of 'SuBa Travels' payable at Kumbakonam";
...
void flight::fibook()
{
	...
	cout<<"\n\t Time  : "<<a.journeyTime<<"\n";
	cout<<"\n\t Fare  : "<<a.f<<"\n";
	cout<<"\n Payment to be made through Demand Draft in favour of 'SuBa Travels' payable at Pict,Pune";
